...
import ReportLOS from '@/reports/reportLOS' //-------------------------
        ...
        <div className="w-full h-[100vh] flex flex-col items-center justify-center">
          <Routes>
            ...
            >
              ...
              <Route path="/report/flow-through" element={<ReportFlowThrough />} /> {/*-------------------------*/}
              <Route path="/report/loss-of-service" element={<ReportLOS />} /> {/*-------------------------*/}
              <Route path="/report/rent-supplement-request" element={<ReportRentSupplement />} /> {/*-------------------------*/}
              <Route path="/report/goals-and-progress" element={<ReportGoalsProgress />} /> {/*-------------------------*/}
              <Route path="/report/safety-plan" element={<ReportSafetyPlan />} /> {/*-------------------------*/}
              <Route path="/report/overdose-safety-plan" element={<ReportOverdoseSafetyPlan />} /> {/*-------------------------*/}
              <Route path="/report/incident-report" element={<ReportIncident />} /> {/*-------------------------*/}
              <Route path="/report/individuals" element={<ReportIndividuals />} /> {/*-------------------------*/}
              <Route path="/report/shelter-diversion-follow-up-log" element={<ReportShelterDiversion />} /> {/*-------------------------*/}
